...
import static cn.cxdproject.coder.common.constants.CommonEventConstants.EVENT_INTER_MEDIATE_RESULT;
...
public class UserOperatorEventInterceptor implements SignalInterceptor {
    ...
    private Admin getAnonymousAdmin() {
        Admin admin = new Admin();
        admin.setId(DEFAULT_USERID);
